...
try:
    ...
    def test_throughput_wilson_different_volumes():
        ...
        for lat_dim in lat_dims:
            ...
            hopdata = {"avx":hop_size, "gpt":0, "template":hop_size}

            for pack,results_sorted,res in [["gpt", results_g_sorted, results_g],
                                          ["avx", results_avx_sorted, results_avx],
                                          ["template", results_t_sorted, results_t]]:
                
                data_size = v_size * 2 + U_size + hopdata[pack]
        ...
        for n in variants:
            ...
            print(f"{n}_throughput_errors_best_20p_in_GiB_per_s =", thrpt_stdevs_best[n])
            print(f"{n}_throughput_errors_all_in_GiB_per_s =", thrpt_stdevs_all[n])
    ...
    def test_throughput_wilson_clover_different_volumes():
        ...
        for lat_dim in lat_dims:
            ...
            for pack,results_sorted,res in [["gpt", results_g_sorted, results_g],
                ...
                data_size = v_size * 2 + U_size + hopdata[pack] + f_size
                data_size_MiB = data_size / 1024**2
