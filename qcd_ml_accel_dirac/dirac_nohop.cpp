...
// replace the next neighbour contributions by the local contribution
// the computation should be the same, but the memory access is far simpler
// this should thus be way faster
                ...
                for (int64_t t = 0; t < v_size[3]; t++){
                        ...
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(0,x,y,z,t,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[0][s] * v_ptr[ptridx6(x,y,z,t,gamx[0][s],gi,vstride)]
                                    )
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(1,x,y,z,t,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[1][s] * v_ptr[ptridx6(x,y,z,t,gamx[1][s],gi,vstride)]
                                    )
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(2,x,y,z,t,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[2][s] * v_ptr[ptridx6(x,y,z,t,gamx[2][s],gi,vstride)]
                                    )
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(3,x,y,z,t,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[3][s] * v_ptr[ptridx6(x,y,z,t,gamx[3][s],gi,vstride)]
                                    )
                                    + U_ptr[ptridx7(3,x,y,z,t,g,gi,ustride)]
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        +gamf[3][s] * v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                    )
                                ) * 0.5;
                            }
                        }
...
at::Tensor dw_call_nohop_Usw (const at::Tensor& U, const at::Tensor& v, double mass){
    ...
    TORCH_CHECK(U.dim() == 7);
    TORCH_CHECK(v.dim() == 6);
    TORCH_CHECK(U.size(4) == 4);
    TORCH_CHECK(U.size(0) == v.size(0));
                ...
                for (int64_t t = 0; t < v_size[3]; t++){
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(x,y,z,t,0,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[0][s] * v_ptr[ptridx6(x,y,z,t,gamx[0][s],gi,vstride)]
                                    )
                                    + U_ptr[ptridx7(x,y,z,t,0,g,gi,ustride)]
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        +gamf[0][s] * v_ptr[ptridx6(x,y,z,t,gamx[0][s],gi,vstride)]
                                    )
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(x,y,z,t,1,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[1][s] * v_ptr[ptridx6(x,y,z,t,gamx[1][s],gi,vstride)]
                                    )
                                    + U_ptr[ptridx7(x,y,z,t,1,g,gi,ustride)]
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        +gamf[1][s] * v_ptr[ptridx6(x,y,z,t,gamx[1][s],gi,vstride)]
                                    )
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(x,y,z,t,2,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[2][s] * v_ptr[ptridx6(x,y,z,t,gamx[2][s],gi,vstride)]
                                    )
                                    + U_ptr[ptridx7(x,y,z,t,2,g,gi,ustride)]
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        +gamf[2][s] * v_ptr[ptridx6(x,y,z,t,gamx[2][s],gi,vstride)]
                                    )
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx7(x,y,z,t,3,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[3][s] * v_ptr[ptridx6(x,y,z,t,gamx[3][s],gi,vstride)]
                                    )
                                    + U_ptr[ptridx7(x,y,z,t,3,g,gi,ustride)]
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        +gamf[3][s] * v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                    )
                ...
                for (int64_t t = 0; t < v_size[3]; t++){
                    ...
                    for (int64_t g = 0; g < 3; g++){
                        for (int64_t gi = 0; gi < 3; gi++){
                            for (int64_t s = 0; s < 4; s++){
                                res_ptr[ptridx6(x,y,z,t,s,g,vstride)] += (
                                    std::conj(U_ptr[ptridx6(x,y,z,t,gi,g,ustride)])
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        -gamf[0][s] * v_ptr[ptridx6(x,y,z,t,gamx[0][s],gi,vstride)]
                                    )
                                    + U_ptr[ptridx6(x,y,z,t,g,gi,ustride)]
                                    * (
                                        -v_ptr[ptridx6(x,y,z,t,s,gi,vstride)]
                                        +gamf[0][s] * v_ptr[ptridx6(x,y,z,t,gamx[0][s],gi,vstride)]
                                    )
