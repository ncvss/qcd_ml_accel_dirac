 ...
 * 
 * @param U_tensor the gauge field configuration, (Lx,Ly,Lz,Lt,4,3,3)-tensor
 * @param v_tensor the vector field, (Lx,Ly,Lz,Lt,3,4)-tensor
 ...
 * @param U_tensor the gauge field configuration, (Lx,Ly,Lz,Lt,4,3,3)-tensor
 * @param v_tensor the vector field, (Lx,Ly,Lz,Lt,3,4)-tensor
 * @param fs_tensor (Lx,Ly,Lz,Lt,6,3,3)-tensor that contains the precomputed
