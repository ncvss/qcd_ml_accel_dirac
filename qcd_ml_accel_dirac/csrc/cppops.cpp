...
TORCH_LIBRARY(qcd_ml_accel_dirac, m) {
    ...
    m.def("dw_avx_templ(Tensor U_tensor, Tensor v_tensor, Tensor hops_tensor, Tensor bound_tensor, float mass) -> Tensor");
    m.def("dwc_avx_templ(Tensor U_tensor, Tensor v_tensor, Tensor fs_tensors, Tensor hops_tensor, float mass, float csw) -> Tensor");
    m.def("dwc_avx_templ_grid(Tensor U_tensor, Tensor v_tensor, Tensor fs_tensors, Tensor hops_tensor, Tensor bound_tensor, float mass) -> Tensor");

    m.def("dw_avx_templ_backw(Tensor U_tensor, Tensor grad_tensor, Tensor hops_tensor, Tensor bound_tensor, float mass) -> Tensor");
    m.def("dwc_avx_templ_grid_backw(Tensor U_tensor, Tensor grad_tensor, Tensor fs_tensors, Tensor hops_tensor, Tensor bound_tensor, float mass) -> Tensor");
}
